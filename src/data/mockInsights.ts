...
const roleBase: Record<Role, RoleContent> = {
  Frontend: {
    ...
    answerTip:
      "가상 스크롤, 이미지 지연 로딩, 상태 분리, React memo/useMemo 적용 순서로 설명하면 좋습니다.",
  },
  Backend: {
    question: "생성형 AI 기능 도입 시 백엔드에서 지연 시간이 커질 때 어떤 구조로 대응하시겠습니까?",
    answerTip:
      "SSE 스트리밍, Semantic Cache, 비동기 큐, 타임아웃 및 재시도 정책을 함께 제시하세요.",
  },
  PM: {
...
export const insightCards: InsightCard[] = [
  {
    ...
    summary:
      "AI 기능 확산으로 실시간 추론, 벡터 검색, 서비스 분리가 핵심 아키텍처 이슈로 부상했습니다.",
    summaryBullets: [
    ...
    secondaryAnswerTip:
      "인덱싱 속도, 검색 정확도(Recall), 운영 복잡도, 기존 인프라 통합성을 기준으로 비교하세요.",
    relatedIds: ["samsung-hbm", "toss-zero-trust", "kakao-mq"],
    coverImageUrl:
      "https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&w=1200&q=80",
    thumbnailUrl:
      "https://images.unsplash.com/photo-1518773553398-650c184e0bb3?auto=format&fit=crop&w=480&q=80",
    badge: "TECH TREND",
    category: "TRENDING",
  },
  {
    ...
    thumbnailUrl:
      "https://images.unsplash.com/photo-1581092583537-20d51b4b4f1b?auto=format&fit=crop&w=480&q=80",
    badge: "TRENDING",
    category: "AI & CHIP",
  },
  {
    ...
    thumbnailUrl:
      "https://images.unsplash.com/photo-1563013544-824ae1b704d3?auto=format&fit=crop&w=480&q=80",
    badge: "SECURITY",
    category: "SECURITY",
  },
  {
    ...
    thumbnailUrl:
      "https://images.unsplash.com/photo-1537432376769-00aabc3b8b8e?auto=format&fit=crop&w=480&q=80",
    badge: "SYSTEM DESIGN",
    category: "ARCH",
  },
  {
