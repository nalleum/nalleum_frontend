        ...
        <main className="space-y-2">
          <section className="border-b border-[#edf1fb] bg-white px-5 py-6">
            <div className="flex items-center gap-4">
              <div className="relative">
                <ProfileAvatar nickname={profile.nickname} size={64} className="h-16 w-16 rounded-2xl border border-[#edf1fb]" />
                <button
                  type="button"
          ...
          <section className="border-b border-[#edf1fb] bg-white px-5 py-6">
            <div className="mb-4 flex items-center justify-between">
              ...
              <span className="rounded bg-[#eef2ff] px-2 py-0.5 text-[11px] font-bold text-primary">업데이트 2025.05</span>
            </div>
          ...
          <section className="border-b border-[#edf1fb] bg-white px-5 py-6">
            ...
            <div className="rounded-2xl border border-[#dfe7ff] bg-[#eef3ff] p-5">
              ...
              <div className="mb-5 flex flex-wrap gap-2">
                <span className="rounded-full border border-[#dfe7ff] bg-white px-2.5 py-1 text-[11px] font-bold text-primary">#백엔드_숙련도_상</span>
                <span className="rounded-full border border-[#dfe7ff] bg-white px-2.5 py-1 text-[11px] font-bold text-primary">#AWS_경험보유</span>
                <span className="rounded-full border border-[#dfe7ff] bg-white px-2.5 py-1 text-[11px] font-bold text-primary">#대규모_트래픽</span>
              </div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div className="rounded-xl border border-[#dfe7ff] bg-white p-3">
                    <div className="mb-2 flex items-center gap-2">
                      <span className="grid h-6 w-6 place-items-center rounded bg-[#f5f8ff] text-[#9aa8c8]"><Building2 size={12} /></span>
              ...
              <button type="button" className="mt-4 w-full rounded-xl bg-primary py-3 text-[14px] font-bold text-white shadow-[0_10px_18px_rgba(79,45,255,0.2)]">
                상세 매칭 리포트 보기
              </button>
            </div>
          </section>
          ...
          <section className="border-b border-[#edf1fb] bg-white px-5 py-6">
            ...
            <div className="space-y-4 rounded-2xl bg-[#f8faff] p-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <button type="button" className="rounded-xl border border-[#edf1fb] bg-white px-4 py-2 text-[14px] font-bold text-[#0f1738]">
                  오후 10:00
                </button>
              </div>
          ...
          <section className="border-b border-[#edf1fb] bg-white px-5 py-6">
            ...
            <div className="space-y-3">
              {mockSchedules.map((schedule, idx) => (
                <article key={schedule.id} className="flex items-center gap-4 rounded-2xl border border-[#edf1fb] bg-white p-4">
                  <div className={`w-12 rounded-xl py-2 text-center ${idx === 0 ? "bg-[#fff6df] text-[#f59e0b]" : "bg-[#ecf3ff] text-[#3b82f6]"}`}>
                  ...
                  <div className="flex-1">
                    <p className="text-[15px] font-bold text-[#0f1738]">{schedule.companyName} {schedule.title}</p>
                    <p className="text-[13px] text-[#7f8fb1]">{schedule.timeLabel}</p>
                  </div>
                  <button type="button" className="text-[#c3cce0]"><EllipsisVertical size={16} /></button>
                </article>
              ))}
            </div>
          </section>
